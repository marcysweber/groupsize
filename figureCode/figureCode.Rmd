...
```{r pptFigure3, echo=FALSE, fig.width=5, fig.height=2}
ggplot(summaryslopedf, aes(x = travelslope)) +
     ...
     labs(
          ...
          y = "# of populations") +
     xlim(-50,150)+
     theme(axis.text=element_text(size = 8), strip.text = element_text(size=8), axis.title = element_text(size =10),panel.grid = element_line(color = "black"),
           panel.grid.major = element_line(color = "gray90"),
           panel.grid.minor = element_line(color = "gray95"), panel.background = element_rect(fill = "white", color = "gray50"),)+
     geom_vline(xintercept = 0, color = "red")
